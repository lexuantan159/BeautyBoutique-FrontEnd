                    ...
                    <div className="w-full border border-black rounded-lg">
                        <Navbar className="w-full z-50 bg-opacity-10 rounded-lg dark:bg-white">
                            ...
                            <Navbar.Collapse className="text-black">
                                ...
                                <div className="text-black hover:text-red-500 transition-all">
                                    <Link to="/https://www.siliconii.com/">
                                        ABOUT
                                    </Link>
                                </div>
                                <div className="text-black hover:text-red-500 transition-all">
                            ...
                            {hasUser ? (
                                <div className="flex md:order-2 text-black">
                                    <div className="flex items-center justify-center">
                                        <Link to="/cart">
                                            <div className="w-10 h-10 rounded-full border border-black group hover:border-red-400 flex items-center justify-center mr-2 hover:text-red-400 transition-all">
                                    ...
                                    >
                                        <Dropdown.Header>
                                            ...
                                            <span className="block truncate text-sm font-medium text-red-400 mt-2">
                                                {user?.email ??
                                                    "This user not have email yet"}
                                            </span>
                                        </Dropdown.Header>
                                        {user?.role?.roleName === "ADMIN" && (
                                            <Link to="/admin/product">
                                                <Dropdown.Item className="font-medium hover:bg-red-400 hover:text-white transition-all">
                                                    DASHBOARD
                                                </Dropdown.Item>
                                            </Link>
                                        )}
