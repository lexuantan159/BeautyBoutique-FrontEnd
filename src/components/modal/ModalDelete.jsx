    ...
    >
      <div className=" dark:bg-white  modal-box relative left-0 right-0 overflow-y-scroll no-scrollbar rounded-lg sm:max-w-full">
        ...
        <div className="modal-action">
          ...
          <button className="border-2 border-red-400 btn px-6 py-2 text-slate-600 min-h-0 h-auto bg-white hover:bg-red-500 hover:text-white hover:border-red-400 box-border">
            Delete
          </button>
        </div>
      </div>
