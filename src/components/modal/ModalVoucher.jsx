    ...
    <>
      <dialog id="my_modal_5" className="modal modal-bottom sm:modal-middle  ">
        <div className="modal-box rounded-lg overflow-y-scroll no-scrollbar">
          <h3 className="font-bold text-xl text-center text-red-400 uppercase">
            Voucher
          </h3>
              ...
              vouchers?.map((item, index) => {
                return (
                  ...
                  >
                    ...
                    <div className="w-full relative col-span-9 pl-2 border-r-dash border-gray-400 p-2 flex flex-col justify-between">
                      <p className="absolute top-2 right-4 font-semibold text-center ">
                      ...
                      <div className="flex items-center justify-between">
                        <p className="text-sm text-gray italic">
                          {item?.voucher?.startDate} - {item?.voucher?.endDate}
                        </p>
                        <p
          ...
          <div className="modal-action">
            <form method="dialog">
              ...
              <button className="btn px-6 py-2 min-h-0 h-auto hover:bg-red-500 hover:text-white outline-none">
                Close
              </button>
            </form>
          </div>
