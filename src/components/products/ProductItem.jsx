            ...
            <div className="w-full grid grid-rows-3 rounded-t-lg shadow">
                <div className="relative w-full row-span-2 rounded-t-lg group overflow-hidden">
                    <img
                        ...
                        src={infoProduct.images[0]?.imageUrl}
                        alt={infoProduct.images[0]?.id}
                    />
                    <div className="absolute inset-0 hidden group-hover:block bg-black/20 rounded-t-lg transition-all"></div>
                    <button className="absolute left-1/2 -translate-x-1/2 -bottom-4 opacity-0 px-2 py-1 text-[14px] font-bold text-white flex infoProducts-center rounded-lg bg-red-400 group-hover:opacity-100 group-hover:bottom-4 transition-all">
                        <MdOutlineAdd
                            size={25}
                ...
                <div className="bg-white px-4 pt-4 w-full border-[1px] border-gray-400 overflow-x-hidden">
                    ...
                    <p className="text-[18px] font-bold mt-1">
                        {infoProduct?.salePrice} $ <br></br>{" "}
                        <span className="text-[15px] font-normal text-gray-500">
                            (main price {infoProduct?.salePrice} $)
                        </span>
                    </p>
                </div>
            </div>
