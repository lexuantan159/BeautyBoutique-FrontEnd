...
const Cart = () => {
    ...
    const handlePayment = () => {
        ...
        cartItemIds.length === 1
            ? navigate(`/ship-detail/${cartItemIds[0]}`)
            : navigate(`/ship-detail/${cartItemIds.join(",")}`);
    };

    return (
        <>
            <div className="max-w-[1200px] grid grid-cols-12 gap-5 mt-10 mx-10 lg:px-2 lg:mx-auto text-slate-500">
                <h1 className="col-span-12 font-semibold text-xl">
                    My Cart{" "}
                ...
                <div className="bg-white col-span-12 lg:col-span-8 rounded-lg shadow-lg max-h-[430px] overflow-y-scroll no-scrollbar border-[0.2px] border-gray-300 pt-3">
                    {isLoading ? (
                        ...
                        <div className="h-full flex flex-col justify-center items-center py-10">
                            <img
                                className="w-10 h-10 md:w-30 md:h-30 "
                                ...
                                alt="sdfd"
                            />
                            <p className="hidden md:block text-lg font-medium mt-2 text-red-400">
                                Your cart is empty!
                            </p>
                        </div>
                    )}
                ...
                <div className="bg-white col-span-12 lg:col-span-4 flex-grow mt-5 lg:mt-0 ">
                    ...
                    <div className="w-full mt-4 bg-white rounded-lg shadow-md px-3 mb-2 border-[0.2px] border-gray-300">
                        <div className="mx-3 flex justify-between items-center">
                            ...
                            <p className="py-2 ">
                                {formatNumber(cart?.data?.totalPrice)}${" "}
                            </p>
                        </div>
                    </div>
                </div>
