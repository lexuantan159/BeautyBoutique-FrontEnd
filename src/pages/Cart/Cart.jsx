    ...
    <>
      <div className="max-w-[1200px] grid grid-cols-12 gap-2 mt-40 mx-auto">
        <h1 className="col-span-12 font-bold text-xl">
          My Cart <span className="font-normal">(2 san pham)</span>
        </h1>
        ...
        <div className="bg-white col-span-4 flex-grow">
          ...
          <div className="w-full mt-4 bg-white rounded-lg shadow-md px-3 pb-3 ">
            <p className="flex items-center py-3 text-lg">
              <PiNewspaperClippingLight className="pr-4 text-black" />
              Voucher
            </p>
            <button className="w-full flex items-center justify-between text-gray-300  text-left py-2 px-3 border-[1px] rounded-lg border-gray-400 mb-2">
              Code Discount <GoChevronRight className="text-xl" />
            </button>
            <p className="p-3 bg-gray-200 text-black rounded-lg border-[0.5px] border-gray-300">
              Nhận ngay quà trị giá 200K cho đơn hàng từ 500K tại Lixibox (HSD:
              30/06/2024
            </p>
          </div>
