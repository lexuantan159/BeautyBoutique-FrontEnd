                    ...
                    <section className="text-center">
                        <div className="pb-12 flex flex-wrap justify-center">
                            ...
                            <div className="w-full shrink-0 grow-0 basis-auto px-3 md:w-8/12 xl:w-6/12 mt-5">
                                ...
                                <p className="mb-6">
                                    Taking care of your skin is essential for maintaining a healthy and radiant
                                    complexion.
                                    With the right skincare routine, you can achieve glowing skin that makes you feel
                                    confident and beautiful.
                                    Here's your ultimate guide to facial skincare, including tips and tricks for
                                    achieving and maintaining healthy skin.
                                    Understanding your skin type is crucial for selecting the right skincare products.
                                    Whether you have oily, dry, combination, or sensitive skin, tailor your skincare
                                    routine to address your specific needs.
                                    Cleansing your face twice a day helps remove dirt, oil, and impurities that can clog
                                    pores and lead to breakouts. Use a gentle cleanser suited to your skin type to
                                    maintain a clean and refreshed complexion.
                                </p>
                                <button className="btn btn-success bg-red-400 text-white uppercase border-none hover:bg-red-400">READMORE</button>
                            </div>
                        </div>
                    </section>
                </div>
