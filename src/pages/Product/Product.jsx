...
const Product = () => {
    ...
    return (
        <div className="mb-14">
            <div
                className="max-w-[1230px] px-[30px] mx-auto py-5">
                <div
                    className="w-full mx-auto h-full flex justify-center items-center border shadow-md rounded-lg py-4">
                    <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-7">
                        <button className="font-inter font-semibold text-center text-[16px] hover:text-red-500 transition-all"
                                onClick={() => {
                                    setCategoryID('')
                                }}> All Product
                        </button>
