...
const Product_Detail = () => {
    ...
    return (
        <div className="max-w-[1200px] mx-auto text-slate-500">
            <scrollToShipping />
            <scrollToReview />
            <scrollToDetail />
            <div className="flex">
                    ...
                    <div>
                        ...
                        >
                            ...
                            >
                                ...
                                - All parcels from StyleKorean are shipped from
                                Korea. <br />- This item cannot be shipped to
                                certain countries or regions. <br />
                                - We are unable to ship to the following
                                address: P.O. Box, APO, FPO, DPO. <br />
                            </div>
                        </div>
                    </div>
                </div>
