  ...
  return (
    <>
      <div className="max-w-[1200px] grid grid-cols-12 gap-5 mt-40 mx-auto">
        <h1 className="col-span-12 font-bold text-xl">
          Ship Detail <span className="font-normal"></span>
        </h1>
        <div className="bg-white col-span-8 max-h-[430px] overflow-y-scroll no-scrollbar">
            ...
            <div className="grid grid-cols-2 gap-4 mt-3">
              <div className="p-3 border-[1px] border-red-500 rounded-lg hover:cursor-pointer ">
                ...
                <p className="truncate">
                  194 Tô hiệu, P Hoa minh, Q Liên Chiểu, Đà Nẵng, TP Đà Nẵng
                </p>
              </div>
              ...
              <div className="p-3 flex flex-col items-center justify-center border-[1px] border-gray-300 border-dashed rounded-lg hover:cursor-pointer">
                <GrAdd />
          ...
          >
            <motion.div className="flex justify-between items-center cursor-pointer">
              ...
              <motion.p
                animate={isExpanded ? itemCross.show : itemCross.hidden}
              >
                <GoChevronRight className="text-xl" />
              </motion.p>
            </motion.div>
            ...
            >
              <motion.p
                ...
                className={
                  isExpanded
                    ? "block text-lg rounded hover:bg-gray-300 py-2 px-3 "
                    : "hidden"
                }
              >
          ...
          <div className="p-3 mb-3 flex justify-between items-center rounded-lg shadow-lg border-[0.2px] border-gray-300">
            <p className="flex items-center ">
              <MdOutlinePayments className="mr-2" /> METHOD PAYMENT
            </p>
            <GoChevronRight className="text-xl" />
          </div>
        </div>
        <div className="bg-white col-span-4 flex-grow">
          ...
          <div className="w-full mt-4 bg-white rounded-lg shadow-md px-3 pb-3 max-h-[260px] overflow-y-scroll no-scrollbar">
            <div className="flex gap-4 p-3 mb-3">
              ...
              <div className="w-full flex flex-col justify-between">
                <p className="block text-sm">
                  Nước Tẩy Trang Chacott Cleansing Water 500ml
                </p>
                <p className="block text-sm">
                  <span className="font-medium">350.000</span> ₫(trị giá 650.000
                  ₫)
                </p>
              </div>
            </div>
