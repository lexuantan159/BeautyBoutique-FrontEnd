  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        if (!vouchersData.error) setVouchers(vouchersData.voucherList);
        else throw new Error('cannot fetch voucher');
        console.log(vouchersData);
      } catch (error) {
        console.error('Error fetching vourcher:', error);
      }
    };
    fetchData();
  }, []);
