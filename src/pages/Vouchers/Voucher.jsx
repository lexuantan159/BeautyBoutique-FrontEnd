                            ...
                            <div className='h-full flex items-center justify-center'>
                                ...
                                <div className='w-1/2 h-full flex items-center justify-center'>
                                    <div>
                                        ...
                                        <span className='block'>Minimum purchase : {voucher.minimumOrder} $</span>
                                        <span className='block'>Maximum discount :{voucher.maximDiscount} $  </span>
                                        <span className='block'>{voucher.title}</span>
                                        <span className='block'>Start Day : {voucher.startDate}</span>
